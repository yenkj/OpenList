...
func (d *PikPakProxy) refreshToken(refreshToken string) error {
...
func (d *PikPakProxy) UploadByOSS(ctx context.Context, params *S3Params, s model.FileStreamer, up driver.UpdateProgress) error {
...
func (d *PikPakProxy) UploadByMultipart(ctx context.Context, params *S3Params, fileSize int64, s model.FileStreamer, up driver.UpdateProgress) error {
